...
export function InstructorCard({ instructor, onDelete }: InstructorCardProps) {
    ...
    return (
        <div
            ...
            className="group relative bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden flex flex-col cursor-pointer"
        >
                    ...
                    <div onClick={(e) => e.stopPropagation()}>
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                                ...
                                <DropdownMenuSeparator />
                                <DropdownMenuItem className="text-red-600" onClick={() => onDelete(instructor.id)}>
                                    Delete Instructor
                                </DropdownMenuItem>
                            </DropdownMenuContent>
                        </DropdownMenu>
